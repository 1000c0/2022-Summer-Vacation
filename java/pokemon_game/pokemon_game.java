...
public class pokemon_game {
	...
	public static void main(String[] args) {
		...
		String[][] all_skill = { { "심판의뭉치", "신속", "화염방사", "용성군" }, { "화룡점정", "신속", "냉동빔", "화염방사" },
				{ "사이코키네시스", "파동탄", "막치기", "냉동펀치" }, { "성스러운불꽃", "불대문자", "바람 일으키기", "원시의힘" },
				{ "불대문자", "화염방사", "불꽃세례", "전광석화" }, { "단에의칼", "불대문자", "원시의 힘", "솔라빔" },
				{ "푸른불꽃", "크로스플레임", "역린", "용의숨결" }, { "대지의힘", "스톤에지", "마그마스톤", "아이언헤드" },
				{ "눈보라", "깨물어부수기", "프리즈드라이", "얼음숨결" }, { "눈보라", "우드헤머", "냉동펀치", "나뭇잎" },
				{ "공간절단", "하이드로펌프", "드래곤크루", "용의숨결" }, { "프리즈드라이", "냉동빔", "크로스썬더", "크로스플레임" },
				{ "파괴광선", "하이드로펌프", "난동부리기", "물기" }, { "에어로블라스트", "불새", "미래예지", "드래곤다이브" },
				{ "근원의파동", "해수스파우팅", "하이드로펌프", "아쿠아테일" }, { "눈보라", "하이드로펌프", "깨물어부수기", "신속" },
				{ "불꽃세례", "불태우기", "폭풍", "불새" }, { "얼음뭉치", "프리즈드라이", "냉동빔", "폭풍" }, { "전기쇼크", "원시의힘", "번개", "방전" } };
		...
		int[] all_hp = { 240, 210, 200, 212, 146, 200, 200, 182, 160, 180, 180, 250, 190, 212, 200, 200 };

		int[][] all_skill_power = { { 50, 40, 45, 65 }, { 60, 40, 45, 45 }, { 45, 40, 20, 40 }, { 50, 55, 20, 30 },
				{ 55, 45, 20, 20 }, { 60, 55, 30, 60 }, { 65, 50, 60, 30 }, { 45, 50, 50, 40 }, { 55, 40, 35, 30 },
				{ 55, 60, 40, 20 }, { 50, 55, 40, 30 }, { 35, 45, 50, 50 }, { 75, 60, 45, 30 }, { 50, 70, 60, 50 },
				{ 55, 75, 55, 45 }, { 55, 55, 40, 40 }, { 20, 30, 55, 70 }, { 20, 35, 45, 55 }, { 20, 30, 55, 40 } };
		...
		while (true) {
				...
				outerLoop: while (true) {
					...
					if (choice.equals("싸운다") | choice.equals("1")) {
						...
						if (count == 0) {
							...
							System.out.print(inven_mon + "몇번째 포켓몬으로 교체하겠습니까?(1,2,3,4,5)");
			...
			if (where.equals("BOSS")) {
				if (count < 3) {
					System.out.println("BOSS에 도전할 자격은 포켓몬 3마리 이상부터 입니다.");
				} else if (count >= 3) {
